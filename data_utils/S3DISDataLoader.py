...
if __name__ == '__main__':
    data_root = r'D:\pythonCode\pythonProject5\data\stanford_indoor3d'
    ...
    train_loader = DataLoader(point_data, batch_size=16, shuffle=True, num_workers=16, use_shared_memory=True, worker_init_fn=worker_init_fn)
    for idx in range(4):
        end = time.time()
